...
import type { BackgroundTaskState, KnowledgeSourceMode, SaveOutlineRequest, TechnicalPlanWorkflowKind } from '../types';
...
interface OutlineEditPageProps {
  ...
  onOutlineConfigChange: (config: { knowledgeSourceMode: KnowledgeSourceMode; referenceKnowledgeDocumentIds: string[]; referenceDifyDatasetIds: string[]; outlineExpansionMode: OutlineExpansionMode; wordControlOptions: OutlineWordControlOptions }) => Promise<void>;
