...
import type { DifyKnowledgeListResult, DifyKnowledgeStatus } from '../../features/knowledge-base/types';
...
export interface YibiaoBridge {
  ...
  technicalPlan: {
    ...
    saveOutlineConfig: (payload: { knowledgeSourceMode: 'local' | 'dify'; referenceKnowledgeDocumentIds: string[]; referenceDifyDatasetIds: string[]; outlineExpansionMode?: OutlineExpansionMode; wordControlOptions: OutlineWordControlOptions }) => Promise<TechnicalPlanState>;
