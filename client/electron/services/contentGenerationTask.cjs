...
async function runContentGenerationTask({ aiService, agentService, workspaceStore, knowledgeBaseService, difyKnowledgeService, updateTask: updateManagedTask, payload, taskControl, previousState }) {
