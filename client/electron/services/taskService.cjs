...
function createTaskService({ aiService, agentService, technicalPlanStore, rejectionCheckStore, duplicateCheckStore, knowledgeBaseService, difyKnowledgeService, duplicateCheckService }) {
  ...
  function startManagedTask(type, payload, runner, initialPartial = {}) {
    ...
    runner({ aiService: runnerAiService, agentService: runnerAgentService, workspaceStore: runnerWorkspaceStore, knowledgeBaseService, difyKnowledgeService, updateTask, payload, taskControl, previousState }).catch((error) => {
